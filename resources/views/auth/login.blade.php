    ...
    <form class="login-form" action="{{ route('login') }}" method="POST">
		...
		<div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="Username" name="email" required autofocus/>
                @if ($errors->has('email'))
                    <span class="help-block">
                        <strong>{{ $errors->first('email') }}</strong>
                    </span>
		...
		<div class="create-account">
			<p>
				 Don't have an account yet ?&nbsp; <a href="{{ route('register') }}" id="register-btn">
				Create an account </a>
			</p>
		</div>
    </form>
